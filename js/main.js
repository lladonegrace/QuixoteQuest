...
(function(){
  ...
  if (grid && modal && modalImg && modalTitle && modalNote && modalClose) {
    const CHARACTERS = [
      ...
      { id:'benengeli', name:'Cide Hamete Benengeli', role:'Fictional Historian', traits:['Critical','Sarcastic'], note:'A fictional Moorish historian whose manuscripts Cervantes "translates." Cervantes uses him to explore authorship, history, and truth in storytelling.', img:'images/hamete.jpg' },
      ...
      { id:'altisidora', name:'Altisidora', role:'Maid of the Duchess', traits:['Bratty','Teasing'], note:'The Duchess’s mischievous maid who pretends to be in love with Don Quixote, mocking his romantic idealism.', img:'images/altisidora.png' },
      { id:'priest', name:'The Priest', role:'Quixote’s Friend', traits:['Concerned','Contradictory'], note:'A friend of Don Quixote who disapproves of chivalric books but secretly enjoys them. He worries about Quixote yet finds humor in his madness.', img:'images/priest.png' },
      { id:'barber', name:'The Barber', role:'Friend Who Helps the Priest', traits:['Skeptical','Supportive'], note:'Another friend of Don Quixote. He recognizes Quixote’s madness and helps the priest plan interventions to stop his knightly pursuits.', img:'images/barber.png' },
      ...
      { id:'lucinda', name:'Lucinda', role:'Cardenio’s Love', traits:['Beautiful','Innocent'], note:'Cardenio’s faithful and gentle lover. Docile and courtly, she becomes the center of the tragic romantic conflict.', img:'images/lucinda.png' },
      { id:'fernando', name:'Ferdinand', role:'Deceptive Duke', traits:['Proud','Cruel'], note:'An arrogant young nobleman who steals Lucinda from Cardenio without remorse, triggering the lovers’ suffering.', img:'images/fernando.png' },
      { id:'dorothea', name:'Dorothea', role:'Faithful Lover', traits:['Clever','Determined'], note:'Ferdinand’s forsaken lover. Courageous and cunning, she disguises herself and fights to reclaim her honor and dignity.', img:'images/dorothea.png' },
      { id:'trifaldi', name:'Countess Trifaldi', role:'Comic Impersonation', traits:['Ridiculous','Exaggerated'], note:'A fictional damsel in distress impersonated by the Duke’s steward. Her absurd tale launches Don Quixote and Sancho on the wooden horse adventure.', img:'images/trifaldi.png' },
      { id:'gines', name:'Gines de Pasamonte', role:'Ungrateful Criminal', traits:['Cunning','Humorous'], note:'A galley slave freed by Don Quixote who later causes trouble. His behavior questions Quixote’s ideas of justice and mercy.', img:'images/gines.png' },
      { id:'roque', name:'Roque Guinart', role:'Chivalrous Bandit', traits:['Generous','Conflicted'], note:'A noble-hearted outlaw who believes in justice but kills a follower for challenging him. A complex mix of honor and violence.', img:'images/roque.png' }
    ];
